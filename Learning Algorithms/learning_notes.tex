...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.4\linewidth]{autoencoderdemo.png}
...
\begin{enumerate}
    ...
    \begin{figure}[H]
    \centering
    \includegraphics[width=0.5\linewidth]{bottleneckAE.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.5\linewidth]{reparameterization.png}
